...
Controllers.controller('IndexController', ['$scope','RequestService',
    function($scope, RequestService) {
        ...
        /*$scope.Univer=RequestService.university({},
            function(data, headers){
                console.log(data);
            },
            $scope.defaultErrorCallback
        );*/
        $scope.Univers=RequestService.list({SearchString: $scope.SearchString},$scope.defaultSuccessCallback,$scope.defaultErrorCallback);
...
Controllers.controller('UniversityController', ['$scope',
    function($scope) {
    }
]);